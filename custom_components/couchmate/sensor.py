...
class SelectionSensor(SensorEntity):
    ...
    def __init__(self,hass,entry,key):
        ...
        self._attr_device_info=DeviceInfo(identifiers={(DOMAIN,entry.entry_id)},name="CouchMate Core Dev Preview",manufacturer="CouchMate",model="Home Assistant entity bridge",sw_version="1.4.0-beta.12")
    @property
